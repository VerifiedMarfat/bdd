Feature: Applying promotional offers to an order
    ...
    Scenario: "Buy Shampoo & get Conditioner for 50% off" offer
        ...
        When the following products are put on the order
            | Category | Title |
            | Shampoo | Sebamed Anti-Dandruff Shampoo 200ml |
            | Conditioner | L'Oréal Paris Hair Conditioner 250ml |
        Then I should get a "50%" discount on "L'Oréal Paris Hair Conditioner 250ml"
